...
export default function Footer() {
  return (
    <footer className="bg-gray-900 py-10 px-8 text-right w-full" dir="rtl">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-10">
        
        <div className="w-full md:w-72 space-y-3">
          <div className="text-primary text-2xl font-black italic tracking-tighter">مُتاح</div>
        ...
        <div className="flex flex-wrap gap-12 md:gap-20 text-right">
          <div className="flex flex-col gap-3">
            <h4 className="text-white font-bold text-base mb-1">عن المنصة</h4>
          ...
          <div className="flex flex-col gap-3">
            <h4 className="text-white font-bold text-base mb-1">القانوني</h4>
        ...
        <div className="flex flex-col gap-3">
          <h4 className="text-white font-bold text-base mb-1">تابعنا:</h4>
          <div className="flex gap-3">
            ...
            <a 
              ...
              className="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center transition-all duration-300 hover:bg-[#1877F2] border border-white/10 group"
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center transition-all duration-300 hover:bg-gradient-to-tr hover:from-[#f9ce34] hover:via-[#ee2a7b] hover:to-[#6228d7] border border-white/10 group"
            >
              <svg className="w-4.5 h-4.5 fill-white" viewBox="0 0 24 24">
